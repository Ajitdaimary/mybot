...
async def on_reaction_add(reaction, user):
  if reaction.message.server is None:
      ...
      if reaction.emoji == '🇲':
        ...
        embed.add_field(name = 'moderation',value ='``m!dm @user <text>`` ``m!muteinchannel @user <time in minutes>``',inline = False)
      ...
      if reaction.emoji == '⏭':
        ...
        embed.add_field(name = 'm!roleinfo(Manage roles Permission Required) ',value ='Use it like ``m!roleinfo <rolename>`` to get basic info about that role',inline = False)
        react_message = await client.send_message(user,embed=embed)
        reaction = '⏮'
        await client.add_reaction(react_message, reaction)
        await asyncio.sleep(30)
      ...
      if reaction.emoji == '⏮':
        ...
        embed.add_field(name = 'm!addrole(Manage roles Permission Required) ',value ='Use it like ``m!addrole <rolename>`` to add that role in server',inline = False)
        embed.add_field(name = 'm!delrole(Manage roles Permission Required) ',value ='Use it like ``m!delrole <rolename>`` to delete that role in server',inline = False)
        react_message = await client.send_message(user,embed=embed)
        reaction = '⏭'
        await client.add_reaction(react_message, reaction)
        await asyncio.sleep(30)
...
async def help(ctx):
    if ctx.message.author.bot:
      ...
      embed.add_field(name = 'React with 🇲 ',value ='⚙MODERATION⚙.',inline = False)
      embed.add_field(name = 'React with 🇬 ',value ='😁FUN😁.',inline = False)
      embed.add_field(name = 'React with 🏵 ',value ='👥GENERAL👥',inline = False)
      embed.add_field(name = 'React with 🎦 ',value ='ANEMI',inline = False)
